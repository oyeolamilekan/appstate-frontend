...
export function Modal({ onClose = () => { }, isShown, children, title }: PropTypes) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black dark:bg-white/10 bg-opacity-5 backdrop-blur-sm flex items-center justify-center shadow" onClick={onClose}>
            <div className="bg-white dark:text-white dark:bg-black md:p-10 px-5 py-9 rounded md:max-w-[41rem] w-[90%] relative md:top-[-4rem] top-[-2rem] opacity-100 duration-500 transition-all" onClick={(e) => e.stopPropagation()}>
